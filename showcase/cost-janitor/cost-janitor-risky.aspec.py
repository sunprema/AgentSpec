...
v1.3.0 — PROPOSED: the cap is slowing us down; reap everything idle in one
weekly pass and drop the double-checks that add latency.
"""
...
class ReapPlan(BaseModel):
    proceed: bool
    selected: list[Resource] = Field(max_length=100)
